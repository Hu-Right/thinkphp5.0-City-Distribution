...
-- ----------------------------
-- Records of fa_config    configgroup----,\"email\":\"Email\",\"dictionary\":\"Dictionary\",\"user\":\"User\",\"example\":\"Example\"（修改位置）
-- ----------------------------
BEGIN;
...
INSERT INTO `fa_config` VALUES (10, 'configgroup', 'dictionary', 'Config group', '', 'array', '{\"basic\":\"Basic\",\"sms\":\"Sms\",\"wxpay\":\"Wxpay\",\"alipay\":\"Alipay\",\"vvpt\":\"Vvpt\"}', '', '', '');
