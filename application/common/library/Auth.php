    ...
    public function register($username, $password, $email = '', $mobile = '', $extend = [])
    {
        ...
        if(empty($extend) === true){
            $data = [
                ...
                'score'    => 0,
                'avatar'   => '',
                'nickname' => 'VV' . mt_rand(100000,999999)
            ];
        }
        if(empty($extend) === false){
            if($extend['nickname'] == ''){
                $extend['nickname'] = 'VV' . mt_rand(100000,999999);
            }
            $data = [
                'username'   => $username,
                'password'   => $password,
                ...
                'QQ_openid'  => $extend['QQ_openid'],
                'WX_openid'  => $extend['WX_openid'],
                'WX_unionid' => $extend['WX_unionid'],
