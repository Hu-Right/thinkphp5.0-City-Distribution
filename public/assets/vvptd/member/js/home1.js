...
function autoOrder(){
    ...
    {
        var source=new EventSource("/vvptd/order/autoOrder");
...
document.getElementById('grzx').addEventListener('tap', function() {
    mui.openWindow({
        ...
        success: function (data) {
            ...
            if(order.length>0){
                ...
                for(var i =0;i<order.length;i++){
                    ...
                    //if(order[i].type =='1'){
                    //    url = baseUrl+"/assets/vvptd/member/img/mai.png";
                    //}else if(order[i].type =='2'){
                    //    url = baseUrl+"/assets/vvptd/member/img/song.png";
                    //}else if(order[i].type =='3'){
                    //    url = baseUrl+"/assets/vvptd/member/img/ban.png";
                    //}else{
                    //    url = baseUrl+"/assets/vvptd/member/img/pai.png";
                    //}
                    //addMarker(pt,i,url);
...
function checkOrder(){
    ...
    mui.ajax('/vvptd/order/checkOrder',{
        ...
        success:function(data){
            ...
            alert(XMLHttpRequest.status+'1111111');
        }
    })
}
//接单成功后展示页面
