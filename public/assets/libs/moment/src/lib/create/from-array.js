...
// note: all VALUES (`userid`, `type`, `money`, `balance`, `relevant_userid`, `orderid`, `status`, `create_time`, `remark`, `ext`)past the year are optional and will default to the lowest possible value.
