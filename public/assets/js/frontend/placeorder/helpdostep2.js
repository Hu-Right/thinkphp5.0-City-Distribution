mui.plusReady(function() {
    ...
    var content = plus.storage.getItem('content'),
        ...
        son_id = plus.storage.getItem('son_id'),
    ...
    //获取子分类价格
    mui.ajax('/index/placeorder/servicePrice',{
        type: 'post',
        data:{id:son_id},
        dataType:'json',//服务器返回json格式数据
        success: function (data) {
            //console.log(data);
            document.getElementById("service_price").value = data;
            //console.log(data);
            if(document.getElementById("is_weather").value == 1){
                document.getElementById("price").innerText = (parseFloat(data) + parseFloat(document.getElementById("weather").value)).toFixed(2);
            }else{
...
function placeAnOrder(orderdata){
    mui.ajax('/index/placeorder/helpdo',{
        type: 'post',
        data:orderdata,
        dataType:'json',//服务器返回json格式数据
        success: function (data) {
...
function price(){
    ...
    var service_price = parseFloat(document.getElementById("service_price").value);
    var money = service_price;

    // console.log('天气加价'+is_weather);
    // console.log('天气是否加价'+weather);
